...
public class ChatManager : MonoBehaviour {
    ...
    public static IEnumerator follow(User other, Action callback)
    {
        string url = string.Format("https://leancloud.cn/1.1/users/{0}/friendship/{1}", currentUser.userID, other.userID);
    ...
    public static IEnumerator searchUser(string userName, Action<List<User>> callback)
    {
    ...
    public static IEnumerator getFollowers(Action<List<User>> callback)
    {
        ...
        {
            string userId = ret["results"][i]["objectId"].Value;
            string userName = ret["results"][i]["username"].Value;
            int charId = ret["results"][i]["charid"].AsInt;
    ...
    public static IEnumerator createChat(User other, Action<string> callback)
    {
    ...
    public static IEnumerator sendMessage(string convId, string otherName, string message, Action callback)
    {
    ...
    public static IEnumerator getChatHistory(string convId, Action<List<Message>> callback)
    {
    ...
    public static IEnumerator getRecent(Action<List<Conversation>> callback)
    {
